...
xlabel('(a).start delay(second)','fontsize',ftsz);
...
xlabel('(b).start delay(second)','fontsize',ftsz);
...
xlabel('(c).start delay(second)','fontsize',ftsz);
ylabel('fraction of views(%)', 'fontsize', ftsz);
...
xlabel('(d).start delay(second)','fontsize',ftsz);
ylabel('fraction of views(%)', 'fontsize', ftsz);
